...
def insert_playlist(id, picture_url, spotify_url):
    data = supabase.table("playlist").insert({"id": id, "picture_url": picture_url, "spotify_url": spotify_url}).execute()
